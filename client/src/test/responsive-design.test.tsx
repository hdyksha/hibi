...
describe('Responsive Design Tests', () => {
  it('should have mobile-first responsive classes in header', () => {
    render(<App />);
  ...
  it('should have responsive layout classes in main content', () => {
    render(<App />);
  ...
  it('should have responsive grid layout for filter and todo list', () => {
